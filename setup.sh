...
if [[ "$SELECTED_LANG" == "ES" ]]; then
    ...
    MSG_PROTO_1="Commit-Sentinel: Propone commits pero NUNCA auto-commitea (Confirmación manual)."
    MSG_PROTO_2="Skill Mastery (CRÍTICO): DEBO activar TODAS las skills relevantes (\`activate_skill\`) al inicio de cada tarea."
    MSG_PROTO_3="Bun & DB: Uso exclusivo de Bun y migraciones (001...) con verificación de constraints."
    ...
    MSG_STATUS_CLI="CLI: Nightly (v0.33.0-nightly.20260302)"
    MSG_STATUS_AGENTS="Agentes: Generalist + Especialistas (Event-Driven Scheduler)"
    MSG_STATUS_PLANNING="Planificación: Persistent & Interactive (v0.33)"
    ...
    MSG_PROTO_1="Commit-Sentinel: Proposes commits but NEVER auto-commits (Manual confirm)."
    MSG_PROTO_2="Skill Mastery (CRITICAL): I MUST activate ALL relevant skills (\`activate_skill\`) at the start of every task."
    MSG_PROTO_3="Bun & DB: Exclusive use of Bun and migrations (001...) with constraint verification."
    ...
    MSG_STATUS_PLANNING="Planning: Persistent & Interactive (v0.33)"
...
OPTIMIZED_SETTINGS='{
  ...
  "general": {
    ...
    "sessionRetention": { "maxAge": "7d", "maxCount": 100 },
  ...
  "agents": {
    "generalist": { "enabled": true, "modelAlias": "elite-coding" },
    "codebaseInvestigator": { "enabled": true, "modelAlias": "thinking-pro" }
  },
  "context": { 
